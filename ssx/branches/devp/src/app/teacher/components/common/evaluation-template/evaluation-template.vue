        ...
        <div class="evaluation-template" v-show="opened" :data="stateData">
            ...
            <div v-if="isSearching" class="as-body-query">
                <scroller-base class="con-query-scroller" :data="queryScroll">
                    <div class="con-list " v-for="(item,index) in queryList" @click="selectCon(item,index)" :key="index">
                    ...
                    <empty-page class="noData-temp" :type="1001" v-if="queryList.length == 0"></empty-page>
                </scroller-base>
            </div>
            <div class="as-body" v-else>
                ...
                <div class="con-area">
                    <scroller-base class="con-scroller" :data="conScroll" ref="conScroller">
                        <div class="con-list" v-for="(item,index) in temConList" @click="selectCon(item,index)" :key="index">
                            <div class="title">{{item.Name}}</div>
                            <div class="con" :class="{more:item.moreFlag}">{{item.Content}}</div>
                            <div class="ic-select">
                                <svg aria-hidden="true" class="icon">
            ...
            <!--确定提交-->
            <div class="footer">
                <div class="manage" @click="openCategoryAS">模板管理</div>
            ...
            <!-- 模板类别 -->
            <category :opened.sync="isOpenCategory"></category>
        </div>
    </transition>
</template>
