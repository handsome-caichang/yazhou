    ...
    <div>
        ...
        <div class="page">
            ...
            <div class="student-box">
                ...
                <div class="data">
                    <div class="data-item">
                        <div><span class="num">{{screenData.onread}}</span>万人</div>
                        <div class="desc">
                            <svg class="icon" aria-hidden="true">
                    ...
                    <div class="data-item">
                        <div><span class="num">{{screenData.newstudent}}</span>人</div>
                        <div class="desc">
                            <svg class="icon" aria-hidden="true">
                    ...
                    <div class="data-item">
                        <div><span class="num">{{screenData.stopped}}</span>人</div>
                        <div class="desc">
                            <svg class="icon" aria-hidden="true">
                    ...
                    <div class="data-item">
                        <div><span class="num">{{screenData.outed}}</span>人</div>
                        <div class="desc">
                            <svg class="icon" aria-hidden="true">
            ...
            <div class="sale-box">
                ...
                <div class="data">
                    <div class="data-item">
                        <div><span class="num blue">{{screenData.facttotal}}</span>万元</div>
                        <div class="desc">
                            <svg class="icon" aria-hidden="true">
                    ...
                    <div class="data-item">
                        <div><span class="num yellow">{{screenData.refundtotal}}</span>万元</div>
                        <div class="desc">
                            <svg class="icon" aria-hidden="true">
                ...
                <div class="sale-box-content">
                    <div class="sale-box-content-item br">
                        <div>预存</div>
                        <div class="unit"><span class="num">{{screenData.preset}}</span>元</div>
                    </div>
                    <div class="sale-box-content-item br">
                        <div>充值</div>
                        <div class="unit"><span class="num">{{screenData.recharge}}</span>元</div>
                    </div>
                    <div class="sale-box-content-item">
                        <div>新增</div>
                        <div class="unit"><span class="num">{{screenData.newadd}}</span>元</div>
                    </div>
                    <div class="split"></div>
                    <div class="sale-box-content-item br">
                        <div>续费</div>
                        <div class="unit"><span class="num">{{screenData.renew}}</span>元</div>
                    </div>
                    <div class="sale-box-content-item br">
                        <div>扩科</div>
                        <div class="unit"><span class="num">{{screenData.plus}}</span>元</div>
                    </div>
                    <div class="sale-box-content-item">
                        <div>其他</div>
                        <div class="unit"><span class="num">{{screenData.other}}</span>元</div>
                    </div>
                </div>
            </div>
                ...
                <div class="consume-box-content">
                    <div class="consume-left">
                        <div class="consume-count">
                            <div class="num margin-5">{{screenData.feehours}}</div>
                            <div>课消数(课时)</div>
                            <svg class="icon" aria-hidden="true">
                        ...
                        <div class="consume-day">
                            <div class="num margin-5">{{screenData.feedays}}</div>
                            <div>课消数(天)</div>
                            <svg class="icon" aria-hidden="true">
                    ...
                    <div class="consume-money">
                        <div>
                            <div class="margin-5"><span class="num">{{screenData.feeconsumeamount}}</span>&nbsp;万元</div>
                            <div>课消金额</div>
                        </div>
                        <svg class="icon" aria-hidden="true">
            ...
            <div class="refund-box">
                ...
                <div class="refund-box-content">
                    <div class="item person">
                        <div>
                            <div class="num margin-5">{{screenData.persontime}}</div>
                            <div>结算（人次）</div>
                        </div>
                        <svg class="icon" aria-hidden="true">
                    ...
                    <div class="item money">
                        <div>
                            <div class="margin-5"><span class="num">{{screenData.refundamount}}</span>&nbsp;万元</div>
                            <div>结算金额</div>
                        </div>
                        <svg class="icon" aria-hidden="true">
                            <use xlink:href="#icon-baobiaojine"></use>
