...
<template>
	<div class="commentDimension-container">
		<div class="body">
			<scroller-base class="scroller" :data="list" ref="commentDimensionListIScroller">
				<!-- 统计维度 -->
				...
				<div class="class-table">
					...
					<div class="comment-list">
						<div class="to-detail" @click="toDimensionAvg(item.itemid,item.scope,item.itemname)" v-for="item in list" :key="item.itemid">
...
export default {
        ...
        return {
            ...
            setOption: {
                ...
                radar: {
                    ...
                    splitLine: {
                        lineStyle: {
                            color: ["rgba(204, 204, 204, 1)"].reverse()
                        }
                    },
                    splitArea: {
                        show: false
    ...
    methods: {
                ...
                res.data= [
                        {
                            itemname: "专业满意度",
                            itemid:
                                "45dd3bdb-8da1-4afc-b918-e65ce4fb451c",
                            scope: "5.0000",
                            myrank: 1
                        },
                        {
                            itemname: "服务周到",
                            itemid:
                                "a36ce1a9-5919-4f14-be54-1633ed1385df",
                            scope: "2.0000",
                            myrank: 1
                        },
                        {
                            itemname: "老师热情可爱",
                            itemidw :
                                "9d9d5586-9e6f-48a9-a2f6-208193c8313f",
                            scope: "2.0000",
                            myrank: 1
                        }
                    ]
        ...
        toDimensionAvg(CourseCommentScopeSettingID, passScope, itemName) {
            ...
            _params.coursecommnetsettingid = CourseCommentScopeSettingID;
            _params.passcope = passScope;
