...
<script>
    import {getBukeFollowList,savemend} from "teacher/api/buke.js";
        ...
        data(){
            return{
                ...
                savePara:{
                    ...
                    endtime: '', //结束时间
                    classroomid: '', //教室ID
                    checkconflict: 0, //是否检查排课冲突（1是，0否）
                    teachemployeeinfo: [{
        ...
        methods:{
            ...
            selectFollowClass(item){
                if(!(this.checkedClassID == item.ID)){
                    ...
                    this.savePara.startime = item.StartTime;
