 ...
 * @Last Modified time: 2018-04-04 10:08:55
 */
			...
			<scroller-base 
				...
				<div class="add-content">
					<div class="txt">
						...
						<textarea 
								v-model="content" 
							  name="notice-content" id="" cols="30" 
							  rows="10" 
							  placeholder="写点儿什么吧！"
							  @touchmove.stop="" 
...
import {addpublishmessage} from "teacher/api/notice";
...
export default {
  ...
  methods: {
    ...
    addNoticeFn() {
        ...
        if (_students > parseInt(app.sysInfo.sendtaskornoticelimit)) {
    ...
    send() {
        ...
        let _params = {
            ...
            publishinfolist: this.accpetItem,
            title: this.title,
            isfile: this.isFile,
            teacheruserid: app.sysInfo.id,
        ...
        addpublishmessage(_params).then(res => {
