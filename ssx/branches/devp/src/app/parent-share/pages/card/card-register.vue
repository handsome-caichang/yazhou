...
<div class="register">
        ...
        <div class="form">
            ...
            <div class="form-item">
                <div class="form-item-bd">
                    <input class="input" type="text" placeholder="学员姓名（汉字全名）" v-model="user.uname" @blur="setName"/>
                    </div>
                </div>
                <div class="form-sex">
                ...
                <div class="form-item">
                    ...
                    <div class="form-code" v-if="initData.EnableSendSMS_Online == '1'">
                        ...
                        <div class="form-code" v-if="initData.EnableSendSMS_Online == '1'">
                            ...
                            <div class="form-item">
                                ...
                                <div class="form-item">
                                    <div class="form-item-bd">
                                        <input class="input" type="password" placeholder="请输入6位数以上的密码" v-model="user.pwd"/>		</div>
                                    </div>
                                    <div class="form-item">
                                        <div class="form-item-bd">
                                            <input class="input" type="password" placeholder="请重新输入密码" v-model="user.rePwd"/>		</div>
                                        </div>
    ...
    <coupon-box :opened.sync="openCard" :coupon="coupon" @close="closeCard">
    </coupon-box>
</div>
</template>
...
export default {
    ...
    methods: {
                ...
                userRegister({
                    ...
                    if (res.errcode == app.errok) {
                        if (res.data) {
                            ...
                            if (this.coupon.Url) {
                                this.coupon.Url = `${this.coupon.Url.indexOf('http') < 0 ? 'https://' : ''}${this.coupon.Url}`
                            }
                            this.openCard = true;
                        }
                    } else {
        ...
        _moreValidate() {
            ...
            if (!this.user.SelectCampusId) {
                app.toast("info", "报名校区不能为空。");
                return;
            }
            if (!this.user.pwd) {
                app.toast("info", "提示密码不能为空");
                return;
            }
            if (!this.user.rePwd) {
