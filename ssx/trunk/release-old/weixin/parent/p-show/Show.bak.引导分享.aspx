...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="//cdnjs.cloudflare.com/ajax/libs/fullPage.js/2.9.4/jquery.fullpage.min.css">
...
<body>
    ...
    <div class="share-dir none">
        <img src="img/share-right-top.png">
    </div>
    ...
    <script type="text/javascript">
        ...
        // 分享引导
        function share_guidance() {
            $('.share-btn').on('click',function () {
                $('.share-dir').removeClass('none');
            })
            $('.share-dir').on('click',function () {
                $('.share-dir').addClass('none');
            })
        }
