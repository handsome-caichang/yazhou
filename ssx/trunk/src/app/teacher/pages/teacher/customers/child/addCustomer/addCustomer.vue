    ...
    <div class="wrapper">
        ...
        <scroller-base class="page1" :data="num" v-if="num===1">
            <div class="item">
                ...
                <div class="item-mid">
                    <input type="text" class="input" v-model="nameText" @blur="check('name')">
                </div>
        ...
        <scroller-base class="page1" :data="num" v-if="num===3">
            ...
            <div class="item">
                ...
                <router-link tag="div" :to="{name:'selectCourse'}" class="item-mid" ></router-link>
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                ...
                saveData({data: JSON.stringify(params),saveFlag: 'postcustomer'}).then(res => {
                    if (res.errcode == app.errok) {
        ...
        created() {
            ...
            app.event.on('selectData',  (type, data) => {
                console.log(data)
            })
        },  
        mounted() {
