    ...
    <div class="page">
        ...
        <scroller-load class="body">
            <div class="item-box">
                ...
                <div class="column3">8000.00</div>
            </div>
            <div class="item-box">
                <div class="column1">解放中路校区</div>
                <div class="column2">31</div>
                <div class="column3">100000.00</div>
            </div>
            <div class="item-box">
                <div class="column1">解放中路校区</div>
                <div class="column2">3</div>
                <div class="column3">4.00</div>
            </div>
        </scroller-load>
        <div class="footer">
            <div class="column1">合计</div>
            <div class="column2">748</div>
            <div class="column3">826.00</div>
        </div>
