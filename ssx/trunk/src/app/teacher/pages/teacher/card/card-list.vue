            ...
            <scroller-base 
				...
				<div  class="item" v-for="(item, index) in searchList" :key="index">
					...
					<div class="top-layout">
						...
						<div class="pre-commnuication" @click="toShareCard(item)">
                            <span class="tip">分 享</span>
                    ...
                    <div class="bottom-layout">
                        <span class="to-buy-detail" v-if="item.statusName == '使用中' && item.authStatus != 0" @click="clickPush(item, 0)">转发</span>
                        <span class="to-buy-detail" @click="clickPush(item, 1)">查看详情</span>
                    </div>
