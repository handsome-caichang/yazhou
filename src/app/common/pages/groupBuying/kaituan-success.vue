...
<template>
	<action-sheet ref="actionsheets" v-show="opened" position="center" class="actionsheet-password" :data="opened">
		<div class="coupon-box">
			<div class="coupon" :style="{backgroundImage: `url(${kaituanSuccess})`}">
...
<script>
import kaituanSuccess from "./kaituansuccess.png";
import btn from "./btn.png";
export default {
    name: "kaituan-success",
    ...
    mounted() {
        this.$nextTick(() => {
            this.$refs.actionsheets.$el.childNodes[0].childNodes[2].style.background =
                "none";
            //  this.$refs.actionsheets.$el.childNodes[0].childNodes[2].style.right =
            // "0"; this.$refs.actionsheets.$el.childNodes[0].childNodes[2].style.left =
            // "0";
            this.$refs.actionsheets.$el.childNodes[0].childNodes[2].childNodes[2].childNodes[0].style.maxHeight =
                "none";
            this.$refs.actionsheets.$el.childNodes[0].childNodes[2].childNodes[2].childNodes[0].style.height =
                "400px;";
            setTimeout(() => {
