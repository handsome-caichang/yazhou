    ...
    <div class="groupBuying-container">
        <scroller-base class="groupBuying" ref="scrollBars" :data="renderData">
            ...
            <div class="content">
                ...
                <!-- 团购信息 -->
                <div class="group-box" :style="'background-image:url('+ cloun + ')'">
                ...
                <div class="group-item" style="margin-top: 0px" v-if="groupmember.length > 0">
                    <div class="title" :style="'background-image:url('+ titlebag + ')'">我的团</div>
                    <div class="content">
                        ...
                        <ul class="user-list">
                            <li v-for="(item,index) in detail.actinsconfiggroup.groupusercount > 4 ? 4 : detail.actinsconfiggroup.groupusercount" :key="index" :class="groupmember[index] ? (groupmember[index].roletype == 1 ? 'leader' : '' ) : ''">
                                <img @load="imgLoad" :src="groupmember[index] ? groupmember[index].photourl : ''" v-if="groupmember[index]">
                ...
                <div class="group-item">
                    <div class="title" :style="'background-image:url('+ titlebag + ')'">拼团介绍</div>
                    <div class="content">
                        <div class="top">
                            <span class="one">1</span>
                            <i class="line"></i>
                            <span class="tow">2</span>
                            <i class="line"></i>
                ...
                <div class="group-item" v-if="groupcunt.length > 0">
                    <div class="title" :style="'background-image:url('+ titlebag + ')'">正在拼团</div>
                    <div class="content">
                        <div class="userbox">
...
export default {
    ...
    data() {
        return {
            ...
            cloun: require("common/img/cloun.png"), // 云朵
            titlebag: require("common/img/titlebag.png"), // title
            userheaderlist: [],
            detail: {
                actinsrecruitcount: {},
                actinsconfiggroup: {},
