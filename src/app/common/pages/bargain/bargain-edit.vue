...
<template>
	<div class="wrapper">
		<loading class="loadings" v-show="isLoading" :bgType='1'></loading>
		...
		<scroller-base class="scroll" ref="scrollBars">
			<p class="header-point">
				...
				<span>提示：注意设置好砍价活动的底价、砍价次数及活动库存数，建议底价不要设置太困难</span>
			</p>
			...
			<div class="seting">
				<div class="input-item">
					...
					<p>
						<input :disabled="isEdit" type="number" maxlength="10" v-model.number="activeRule.originalprice" placeholder="原价">元
					</p>
				</div>
				...
				<div class="input-item ">
					<span class="require-icon">底价</span>
					<p>
						<input :disabled="isEdit" type="number" maxlength="10" v-model.number="activeRule.floorprice" placeholder="底价">元
					</p>
				</div>
				<p class="setting-point line  border-bottom">
					<svg class="icon" aria-hidden="true">
					...
					砍价最终能得到的底价，活动发布后，不能再修改
				</p>
				<div class="input-item">
					<span class="require-icon">参与砍价人数</span>
					<p><input :disabled="isEdit" type="number"  maxlength="3" v-model.number="activeRule.bargainusercount" placeholder="砍价人数">人</p>
				</div>
				<p class="setting-point line  border-bottom">
					<svg class="icon" aria-hidden="true">
						<use xlink:href="#iconzhushishuoming"></use>
					</svg>
					要多少人帮助砍价，才能实现底价，建议适中，活动发布后，不能再修改
				</p>
				<div class="input-item">
					<span class="">活动发起人数</span>
					<p><input type="number"  maxlength="5" v-model.number="activeRule.enterusercountmax" placeholder="发起人数">人</p>
				</div>
				<p class="setting-point line  border-bottom">
					<svg class="icon" aria-hidden="true">
						<use xlink:href="#iconzhushishuoming"></use>
				...
				<div class="input-item border-bottom flex-row" style="padding-bottom: 20px;">
...
import { templateData } from "./001/bargain.js";
...
export default {
    ...
    methods: {
        ...
        preview() {
            ...
            this.setEndTime(this.activeSeting.activedTime);
        ...
        setEditData() {
            ...
            this.activeRule.originalprice = this.detail.actinsconfigbargain.originalprice;
            this.activeRule.floorprice = this.detail.actinsconfigbargain.floorprice;
            this.activeRule.bargainusercount = this.detail.actinsconfigbargain.bargainusercount;
            this.activeRule.enterusercountmax = this.detail.actinsconfigbargain.enterusercountmax;
        ...
        setUpdate() {
            let data = {
                ...
                actinsconfigbargain: {
                    //活动实例砍价配置
                    originalprice: this.activeRule.originalprice, // 原价
                    floorprice: this.activeRule.floorprice, // 底价
                    bargainusercount: this.activeRule.bargainusercount, // 砍价人数
                    enterusercountmax: this.activeRule.enterusercountmax // 发起砍价活动人数上限
                },
                actinsfilelist: []
            };
            return data;
        ...
        verification() {
            ...
            if (!this.activeRule.originalprice) {
                app.toast("error", "请填写原价");
                return false;
            }
            if (!this.activeRule.floorprice) {
                app.toast("error", "请填写底价");
                return false;
            }
            if (!this.activeRule.bargainusercount) {
                app.toast("error", "请填写参与砍价人数");
                return false;
            }
