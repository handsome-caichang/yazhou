/** 
  * 基于 vue-router v2.7.0 改动
  * 在VueRouter类中新增了一个beforeChange钩子,
  * 在实例方法'push'、'replace'时可以对传入的location进行加工处理
**/
...
var VueRouter = function VueRouter (options) {
  ...
  this.beforeChange = options.beforeChange || (location => location);
