<style scoped lang="scss">
    ...
    .course-charge-campus-container {
        .scroller {
...
<template>
    <div class="course-charge-campus-container">
        <scroller-super
                class="scroller"
                ...
                @loadData="loadData"
                ref="CourseChargeCampusScroller">
            <!--图标区域-->
            ...
            <div class="data-area">
                <div class="data-header">
                    <div class="header-item title">{{app.sysInfo.Title_Campus}}</div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                echartList: [],
                pagingOption: {
                    api: queryMoneyCountOfAllCampus,
                    params: {
                        areaId:'',
                        sdate: '',
                        edate: '',
        ...
        methods: {
            ...
            refresh(params) {
                this.$refs.CourseChargeCampusScroller.refresh(params)
            },
            //日期选择
            changeDate(obj) {
                this.isLoading = true;
            ...
            goTo(item){
                ...
                this.$router.push({path: `/courseChargeCampusBranch/${item.CampusID}${para}`})
            }
        },
        created() {
            ...
            // 筛选条件的传递 有就会覆盖日期
            let para = app.ls.getStorage('courseChargeFilterObj');
            if(para) {this.filterData = para}
            // id 以及查询参数
