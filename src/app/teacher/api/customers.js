...
//获取邀约查询记录
export function queryInvite(params) {
    return axios.ajax('/api/customer/QueryInvite', params)
}

//修改客户状态
export function putVisitStatus(params) {
    return axios.ajax('/api/customer/PutVisitStatus', params)
}