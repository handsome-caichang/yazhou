...
<template>
	<div class="system-overdue">
		<!-- 产品功能即将到期 -->
		<div class="due-dialog" v-if="app.sysInfo.SystemStatus.IsPastDue==1&&opened">
		...
		<!-- 产品功能已到期 -->
		<div class="due-page" v-if="app.sysInfo.SystemStatus.IsPastDue==2">
        ...
        <!-- 师生信正在审核 -->
        <div class="due-page" v-if="app.sysInfo.SystemStatus.IsPastDue==3">
