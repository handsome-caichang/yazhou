...
<template>
    <div class="entry-list">
        ...
        <div class="result">搜索结果（{{list.length}}人）</div>
...
<script>
     ...
     */
    import {getsignuplist,followshareenter} from 'manage/api/common.js';
    ...
    export default {
        ...
        created() {
            this.pagingOption.params.instanceids = [this.$route.params.id];
        },
        watch: {
            inputVal(val){
                if (val !== '') {
