...
<template>
    <div class="comment-share-container">
            ...
            <div v-if="isshow">
                    ...
                    <div class="comment">
                        ...
                        <div class="content">
                            ...
                            <div class="voice" ref="voiceBox">
                                ...
                                <div :data-url="item.FilePath" class="itemVoice"
                                     v-for="(item, index) in detail.ListAudioFile" :key="index">
                ...
                >
                    <div class="info">
                        ...
                        <div class="photo" v-if="schoolInfo.companyLogoPath.length>0"
                             :style="'backgroundImage:url(https:'+ schoolInfo.companyLogoPath +''"></div>
                        <div class="photo" v-else
                             :style="'backgroundImage:url('+ require('./imgs/Group-2@3x.png') +''"></div>
                        <div class="name">{{ schoolInfo.companyName }}</div>
                        <!-- <div class="desc">{{ schoolInfo.companyDes }}</div> -->
                        <rich-text-area
                                class="rich-text"
                                v-if="schoolInfo.companyDes"
                                :richText="app.tool.richTextToHtml(schoolInfo.companyDes,true)"
                        ></rich-text-area>
                        <div class="tel" v-if="schoolInfo.compnayTel&&schoolInfo.compnayTel!=''">
                            ...
                            <a class="tel-number" v-for="item in schoolInfo.companyTelArr" :key="item"
                               :href="'tel:'+item">{{
                                item }}</a>
                        </div>
                    </div>
                    <div class="banner-wrap" v-if="schoolInfo.companyImages.length >= 1">
                        <div class="alone-img" v-if="schoolInfo.companyImages.length == 1"
                             @click="previewImage(schoolInfo.companyImages, 0)"
                             :style="'backgroundImage:url('+ schoolInfo.companyImages[0].FilePath +''">
                        </div>
                ...
                <div class="jion-us" :style="'background-image:url('+ require('./imgs/jion-us.png') + ')'">
                    ...
                    <div class="code imgCode" id='code64'>
                        ...
                        <div v-if="getFlag" @click="getImgCode"
                             :style="'background-image:url('+ codebase64 + ')'"></div>
                    ...
                    <div class="sub-box" v-if="getFlag">
                        <div class="share-btn" @click="openGuide">分 享</div>
                        <div class="btn" @click="joinUs">报 名</div>
                    </div>
                    <div class="sub-box" v-else>
                        <div class="share-btn" @click="openGuide">分 享</div>
                        <div class="btn">报 名</div>
                    </div>
                </div>
        ...
        <div class="guide" v-show="guide" @click="closeGuide">
                    ...
                    if (res.ErrorCode == 200) {
                        ...
                        app.confirm({
                            ...
                            html: ' <div>'+
                                ...
                                '             <svg aria-hidden="true" class="icon star" style="font-size:34px;text-align:center">' +
                                '                  <use xlink:href="#icon-chenggong"></use>' +
                                '             </svg>' +
                                '         </div>' +
                                '         <div style="color:#333333;font-size:16px;text-align:center;margin:13px 0 18px 0">报名成功</div>' +
                                '         <div style="color:#666666;font-size:14px;text-align:center;margin-bottom:13px;">分享即有机会获得更多试听特权哦~</div>' +
                                '</div>',
                            btns: [{
                                text: '关闭',
                                style: {color: '#7B7B7B'},
