    ...
    <div class="wrapper">
        <scroller-base class="scroll" :data="showMore">
            ...
            <div class="item" @click="showSelectSource=true">
                ...
                <span class="spec">*</span>
                <div class="mid">{{sourceObj.name}}</div>
                <div class="right">
            ...
            <div class="item" @click="openCommAction('campusList')">
                ...
                <span class="spec">*</span>
                <div class="mid">{{campusObj.name}}</div>
                <div class="right">
                    <svg aria-hidden="true" class="icon">
                        <use xlink:href="#icon-jiantou"></use>
                    </svg>
            ...
            <div v-if="showMore">
                ...
                <div class="item" @click="openCommAction('statusList')">
                    ...
                    <!-- <span class="spec">*</span> -->
                    <div class="mid">{{statusObj.name}}</div>
                    <div class="right">
                ...
                <div class="item" @click="relatedWx">
                ...
                <div class="item" @click="openCommAction('schoolList')">
                    ...
                    <!-- <span class="spec">*</span> -->
                    <div class="mid">{{schoolObj.name}}</div>
                    <div class="right">
                        <svg aria-hidden="true" class="icon">
                            <use xlink:href="#icon-jiantou"></use>
                        </svg>
                ...
                <div class="item" @click="openCommAction('gradeList')">
                    ...
                    <!-- <span class="spec">*</span> -->
                    <div class="mid">{{gradeObj.name}}</div>
                    <div class="right">
                        <svg aria-hidden="true" class="icon">
                            <use xlink:href="#icon-jiantou"></use>
                        </svg>
...
<script>
    ...
    import {getcustomerinformationconfiglist, opCustomerInfo, getCampuslist, getCurrentManager} from 'crm/api/yy.js'
    export default {
        data() {
            return {
            ...
            submit() {
                ...
                let params = {
                    ...
                    source: {
                        ...
                        name: this.sourceObj.name
                    },
                    status: this.statusObj.id,
                    campus: {
                        id: this.campusObj.id,
                        name: this.campusObj.name
                    },
                    grade: this.gradeObj,
