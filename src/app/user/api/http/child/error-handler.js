...
export function serverCode540(res) {
    if (res.data.result.code == 540) {
        ...
        url += `&terminal=2&wxid=${store.state.userInfo.wxid}&uid=${store.state.userInfo.uid}&company=${store.state.userInfo.company}&returl=${encodeURIComponent(location.href)}`
