/* via  build: 2018-05-18 23:09:10; packages: vue,vue-router,vuex,axios,iscroll;*/
/*!
 * Vue.js v2.5.16
...
(function(window, document, Math) {
	...
	IScroll.prototype = {
		...
		_start: function(e) {
			...
			// 加上!isIDevice 是为了实现在ios设备上，点击任何地方都可以让“选择复制”区域消失
			// if (this.options.preventDefault && !utils.isBadAndroid && !utils.preventDefaultException(e.target, this.options.preventDefaultException)) {
			if (!isIDevice && this.options.preventDefault && !utils.isBadAndroid && !utils.preventDefaultException(e.target, this.options.preventDefaultException)) {
				e.preventDefault();
			}
		...
		_end: function(e) {
			...
			if (!isIDevice && this.options.preventDefault && !utils.preventDefaultException(e.target, this.options.preventDefaultException)) {
				e.preventDefault();
			}
